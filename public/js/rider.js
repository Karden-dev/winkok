...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const notificationSound = new Audio('./assets/sound.mp3'); 
                    ...
                    <div class="order-actions">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="https://wa.me/${order.customer_phone}"><i class="bi bi-whatsapp"></i> WhatsApp</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
